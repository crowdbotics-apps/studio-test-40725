"""
Django settings for studio_test_40725 project.
...
ROOT_URLCONF = 'studio_test_40725.urls'
...
WSGI_APPLICATION = 'studio_test_40725.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studio_test_40725 API",
    "DESCRIPTION": "API documentation for studio_test_40725 App",
    "VERSION": "v1",
}
